...
import eCurrency.ECurrencyEnum;
...
public class ECurrencyRate {
    ...
    public static class ERate {
        ...
        public void setERate(ECurrencyEnum eCurrency, ECurrencyRate.ERate rate) {
            mapECurrency.put(eCurrency, rate);
        }

        public ECurrencyRate.ERate getERate(ECurrencyEnum eCurrency) {
            return Optional
                    .ofNullable(mapECurrency.get(eCurrency))
                    .orElse(new ECurrencyRate.ERate(0f, 0f, 0f, 0f, 0f));
        }
